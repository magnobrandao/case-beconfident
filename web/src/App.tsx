...
function App() {
  ...
  return (
    <div style={{width:'100vw',height:'100vh',display:'flex',flexDirection:'column',fontFamily:'Inter,system-ui,sans-serif',background:'#0d0d0d',color:'#c5c6c7',overflow:'hidden'}}>
      <div style={{display:'flex',flexWrap:'wrap',alignItems:'center',justifyContent:'space-between',gap:16,padding:'12px 20px',borderBottom:'1px solid #1a1a1a',background:'#0a0a0a'}}>
        <div style={{display:'flex',alignItems:'center',gap:16,flexWrap:'wrap',justifyContent:'center',width:'100%'}} className="md:w-auto md:justify-start">
        ...
        <div style={{display:'flex',gap:6,flexWrap:'wrap',justifyContent:'center',width:'100%'}} className="md:w-auto md:justify-end">
      ...
      {/* Tab Navigation */}
      <div style={{display:'flex',borderBottom:'1px solid #1a1a1a',background:'#0e0e0e',overflowX:'auto',whiteSpace:'nowrap',width:'100%'}}>
        {tabs.map(t => (
